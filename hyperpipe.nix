{ mkDerivation, base, brick, bytestring, cereal, containers, hpack
, HsYAML, lib, mtl, optparse-applicative, pcap, string-interpolate
...
mkDerivation {
  ...
  executableHaskellDepends = [
    base brick bytestring cereal containers HsYAML mtl
